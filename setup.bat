...
setlocal
chcp 65001 >nul
title Golem v7.2 Setup (Hydra Dual-Link) - Pure Installer

echo ========================================================
echo   🦞 Golem v7.2 (Hydra Dual-Link) 環境部署工具
...
:: 建立 V7.2 專用的 .env (若不存在)
if not exist .env (
    echo    - 正在建立 V7.2 雙平台 .env 範本...
    (
        echo # ======================================================
