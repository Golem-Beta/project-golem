...
this.browser = null;
this.page = null;
this.memoryPage = null; // ✨ [v8.0] 本地向量海馬迴
...
await new Promise(r => setTimeout(r, 5000)); // 等待模型載入
} catch (e) {
...
const actionContent = actionMatch ? actionMatch[1].trim() : raw; // Fallback to raw if no tags
